...
export function CreateUserDialog({ userRole }: { userRole: string }) {
  ...
  return (
    <Dialog>
      <DialogTrigger render={<Button className="rounded-lg bg-[#f5eb10] text-[#1d1d1d] font-semibold hover:bg-[#f5eb10]/90 shadow-sm" />}>
        ...
        {state?.success ? (
          ...
          <form action={formAction} className="space-y-4">
            ...
            <div className="flex justify-end gap-3 pt-2">
              <DialogClose render={<Button variant="outline" className="rounded-lg border-[#e5e5e5]" />}>
                Cancel
              </DialogClose>
              <Button
                type="submit"
